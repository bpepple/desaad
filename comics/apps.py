...
from comics.signals import pre_delete_character, pre_delete_image, pre_delete_issue
...
class ComicsConfig(AppConfig):
    ...
    def ready(self):
        ...
        pre_delete.connect(
            pre_delete_character, sender=character, dispatch_uid="pre_delete_character"
        )
        ...
        pre_delete.connect(
            pre_delete_issue, sender=issue, dispatch_uid="pre_delete_issue"
        )
